...
- [ ] 1.4 Open the PR referencing #555, stating the value was read from the archive and how it was verified
...
- [ ] 2.6 After the PR opens, confirm in the Renovate job log that the `-updates` 404s are gone and pins still resolve
...
- [ ] 3.4 Close #555 referencing the repin, and note in #536 that the patch half of the hardcoded-`17` collision rots independently of the major
