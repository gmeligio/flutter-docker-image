...
- [ ] 1.6 Keep the `test/android.yml` artifact upload exactly as-is. It is a separate artifact, consumed independently by `compose-version-manifest`.
