...
- **Out of scope** (explicitly listed for the future reader): co-maintainer onboarding; requiring approving reviews; base-image transitive CVEs (vendor-controlled); adding new required status checks for p7/p8/p9 outputs (do those in a follow-up after each of those changes archives).
