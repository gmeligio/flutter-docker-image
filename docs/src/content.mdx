...
export const fastlaneVersion = version.fastlane.version
export const gradleVersion = version.android.gradle.version
export const buildToolsVersion = version.android.buildTools.version
export const repositoryPath = 'gmeligio/flutter-android'
export const imageUri = `${repositoryPath}:${flutterVersion}`
export const androidPlatformVersions = version.android.platforms.map(p => p.version).join(', ')
