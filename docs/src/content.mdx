...
export const javaVersion = androidJson.java.version
...
export const webRepositoryPath = 'gmeligio/flutter-web'
export const webDockerHubUri = `${webRepositoryPath}:${flutterVersion}`
export const webGithubUri = `ghcr.io/${webDockerHubUri}`
export const webQuayUri = `quay.io/${webDockerHubUri}`
export const webDockerHubUrl = `https://hub.docker.com/r/${webRepositoryPath}`
export const webQuayUrl = `https://quay.io/repository/${webRepositoryPath}`
...
- Java (OpenJDK): {javaVersion}
- Android SDK Platform: {androidPlatformVersions}
...
|---------------------------|--------------------------------------------------------|
| Docker Hub                | <a href={webDockerHubUrl}>{webDockerHubUri}</a>    |
| GitHub Container Registry | <a href="https://github.com/gmeligio/flutter-docker-image/pkgs/container/flutter-web">{webGithubUri}</a> |
| Quay                      | <a href={webQuayUrl}>{webQuayUri}</a> |
