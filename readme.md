...
```bash
# Android
docker build --target android --build-arg flutter_version=3.22.2 --build-arg fastlane_version=2.220.0 --build-arg android_build_tools_version=30.0.3 --build-arg android_platform_versions="34" -t android-test .
```
