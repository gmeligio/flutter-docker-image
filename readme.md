...
Minimal Docker images for building Flutter apps in Continuous Integration (CI), for Android, Web, and Windows platforms, with the SDK and toolchain predownloaded so `flutter` runs without extra downloads. Images track the Flutter **stable** channel and the current version is **3.47.1**.
...
| --- | --- | --- | --- |
| Docker Hub | [gmeligio/flutter-android:3.47.1](https://hub.docker.com/r/gmeligio/flutter-android) | [gmeligio/flutter-web:3.47.1](https://hub.docker.com/r/gmeligio/flutter-web) | [gmeligio/flutter-windows:3.47.1](https://hub.docker.com/r/gmeligio/flutter-windows) |
| GitHub Container Registry | [ghcr.io/gmeligio/flutter-android:3.47.1](https://github.com/gmeligio/flutter-docker-image/pkgs/container/flutter-android) | [ghcr.io/gmeligio/flutter-web:3.47.1](https://github.com/gmeligio/flutter-docker-image/pkgs/container/flutter-web) | [ghcr.io/gmeligio/flutter-windows:3.47.1](https://github.com/gmeligio/flutter-docker-image/pkgs/container/flutter-windows) |
| Quay | [quay.io/gmeligio/flutter-android:3.47.1](https://quay.io/repository/gmeligio/flutter-android) | [quay.io/gmeligio/flutter-web:3.47.1](https://quay.io/repository/gmeligio/flutter-web) | [quay.io/gmeligio/flutter-windows:3.47.1](https://quay.io/repository/gmeligio/flutter-windows) |
