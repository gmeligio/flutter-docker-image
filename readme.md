...
| ------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| Docker Hub                | [gmeligio/flutter-android:3.35.2](https://hub.docker.com/r/gmeligio/flutter-android)                                       |
| GitHub Container Registry | [ghcr.io/gmeligio/flutter-android:3.35.2](https://github.com/gmeligio/flutter-docker-image/pkgs/container/flutter-android) |
| Quay                      | [quay.io/gmeligio/flutter-android:3.35.2](https://quay.io/repository/gmeligio/flutter-android)                             |

On the terminal:

```bash
# From GitHub Container Registry
docker run --rm -it ghcr.io/gmeligio/flutter-android:3.35.2 bash
```
...
jobs:
  build:
    ...
    container:
      image: ghcr.io/gmeligio/flutter-android:3.35.2
    steps:
      - name: Checkout
...
* Docker image: gmeligio/flutter-android:3.35.2
...
* `flutter_version <string>`: The version of Flutter to use when building. Example: 3.35.2
...
```bash
# Android
docker build --target android --build-arg flutter_version=3.35.2 --build-arg fastlane_version=2.228.0 --build-arg android_build_tools_version=35.0.0 --build-arg android_platform_versions="36" -t android-test .
```
